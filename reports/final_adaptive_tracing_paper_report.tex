...
The completed evidence base consists of 40 controller-comparison runs, 2 fixed-rate baselines, and 48 runtime-change reinforcement-learning runs across the four applications. Grafana QuickPizza contributes 10 controller-comparison runs and 12 runtime-change runs within that total, alongside 3 fixed-rate checks used as supporting context.
...
Grafana QuickPizza & Pizza recommendation microservice application & Grafana-maintained demo system used as the fourth comparative application in the study & Grafana local stack with Alloy, Prometheus, Tempo, Loki, Pyroscope, Grafana, and QuickPizza microservices & Bandit \\
\bottomrule
\end{tabularx}
\end{table*}
...
\pie[
    radius=1.34,
    text=legend,
    color={navyblue,slategray},
    after number=
]
{5/RL, 3/Non-RL}
\end{tikzpicture}
\caption{Comparison-stage latency winner family split}
\end{figure}
...
\begin{axis}[
    ...
    ymin=0,
    ylabel={Wins},
    symbolic x coords={{Bandit latency},{Q-Learning latency},{Rule latency},{SARSA QPS},{Bandit QPS}},
    xtick=data,
...
\addplot coordinates {({Bandit latency},4) ({Q-Learning latency},1) ({Rule latency},3) ({SARSA QPS},2) ({Bandit QPS},2)};
\end{axis}
\end{tikzpicture}
\caption{Selected policy win counts in the comparison study}
\end{figure}
...
Train-Ticket & Healthy & Bandit & 118.58 ms & SARSA & 62.551 & Q-Learning & 0.1031 \\
Train-Ticket & Faulted & Q-Learning & 96.29 ms & Q-Learning & 35.360 & Q-Learning & 0.0767 \\
Timescale OpenTelemetry Demo & Healthy & Rule & 133.85 ms & SARSA & 2.630 & SARSA & 0.3706 \\
Timescale OpenTelemetry Demo & Faulted & Rule & 211.29 ms & K-Means & 2.275 & Q-Learning & 0.5073 \\
Spring Petclinic Microservices & Healthy & Bandit & 15.86 ms & Bandit & 0.945 & Bandit & 0.2105 \\
Spring Petclinic Microservices & Faulted & Bandit & 8.11 ms & Bandit & 4.418 & Bandit & 1.3779 \\
Grafana QuickPizza & Healthy & Rule & 116.28 ms & Rule & 9.196 & Bandit & 1.4693 \\
Grafana QuickPizza & Faulted & Bandit & 0.00 ms & Q-Learning & 8.996 & Bandit & 2.8662 \\
\bottomrule
\end{tabularx}
\end{table*}
...
Controller behavior under runtime change is not uniform. Across the sixteen system-scenario cases, Bandit wins the most latency cases (7), SARSA wins the most QPS cases (8), and contextual reward leadership is split across all three reinforcement-learning policies. This indicates that different controllers react differently to degradation patterns rather than sharing a common adaptation profile.
...
\begin{axis}[
    ...
    ymin=0,
    ylabel={Cases},
    symbolic x coords={{Bandit},{Q-Learning},{SARSA}},
    xtick=data,
    xticklabel style={rotate=24,anchor=east,font=\scriptsize,align=right,text width=1.45cm},
    nodes near coords,
    nodes near coords style={font=\scriptsize},
...
\addplot coordinates {({Bandit},7) ({Q-Learning},5) ({SARSA},4)};
\end{axis}
\end{tikzpicture}
\caption{Latency wins under runtime-change scenarios}
\end{figure}
...
\pie[
    radius=1.34,
    text=legend,
    color={tealrule,navyblue,orangeaccent},
    after number=
]
{8/SARSA, 6/Q-Learning, 2/Bandit}
\end{tikzpicture}
\caption{Runtime-change QPS winner split}
\end{figure}
...
\begin{axis}[
    ...
    ybar,
    ymin=0,
    ylabel={Average tracing rate},
    symbolic x coords={{Rule},{K-Means},{Bandit},{SARSA},{Q-Learning}},
    xtick=data,
    xticklabel style={rotate=24,anchor=east,font=\scriptsize,align=right,text width=1.45cm},
    nodes near coords,
    nodes near coords style={font=\scriptsize},
...
\addplot coordinates {({Rule},0.15694444444444447) ({K-Means},0.10000000000000002) ({Bandit},0.08208031400966184) ({SARSA},0.08775087598246332) ({Q-Learning},0.07657828282828283)};
\end{axis}
\end{tikzpicture}
\caption{Average selected tracing rate across the full study}
\end{figure}
...
Train-Ticket & Healthy & Q-Learning & 54.64 ms & SARSA & 68.727 & Q-Learning & 2.2526 & 0 \\
Train-Ticket & Latency Spike & Q-Learning & 73.76 ms & SARSA & 34.769 & Bandit & 0.0405 & 0 \\
Train-Ticket & Error Burst & Bandit & 78.15 ms & Q-Learning & 45.003 & SARSA & 0.0496 & 0 \\
Train-Ticket & Throughput Drop & Bandit & 78.09 ms & SARSA & 24.638 & Bandit & 0.0283 & 0 \\
Timescale OpenTelemetry Demo & Healthy & SARSA & 198.71 ms & SARSA & 1.931 & Q-Learning & 0.4598 & 0 \\
Timescale OpenTelemetry Demo & Latency Spike & Bandit & 344.65 ms & Bandit & 1.605 & Q-Learning & 11.9646 & 0 \\
Timescale OpenTelemetry Demo & Error Burst & Q-Learning & 334.96 ms & SARSA & 1.447 & SARSA & 0.4667 & 0 \\
Timescale OpenTelemetry Demo & Throughput Drop & SARSA & 140.85 ms & SARSA & 3.330 & SARSA & 0.3228 & 0 \\
Spring Petclinic Microservices & Healthy & SARSA & 10.05 ms & Bandit & 3.037 & Bandit & 0.8426 & 1 \\
Spring Petclinic Microservices & Latency Spike & Bandit & 5.23 ms & Q-Learning & 7.942 & Q-Learning & 1.7679 & 0 \\
Spring Petclinic Microservices & Error Burst & Q-Learning & 12.11 ms & SARSA & 4.644 & SARSA & 0.6268 & 0 \\
Spring Petclinic Microservices & Throughput Drop & Bandit & 17.81 ms & Q-Learning & 2.519 & Q-Learning & 0.7116 & 1 \\
Grafana QuickPizza & Healthy & Q-Learning & 125.19 ms & Q-Learning & 9.000 & SARSA & 1.4311 & 2 \\
Grafana QuickPizza & Latency Spike & SARSA & 124.38 ms & Q-Learning & 9.095 & Q-Learning & 3.0482 & 3 \\
Grafana QuickPizza & Error Burst & Bandit & 4.49 ms & Q-Learning & 14.401 & Bandit & 4.5680 & 5 \\
Grafana QuickPizza & Throughput Drop & Bandit & 131.98 ms & SARSA & 0.900 & SARSA & 0.1302 & 0 \\
\bottomrule
\end{tabularx}
\end{table*}
...
\midrule
Train-Ticket & 10 & 24.3 & 0 & 12 & 24.1 & 0 \\
Timescale OpenTelemetry Demo & 10 & 4.0 & 0 & 12 & 6.0 & 0 \\
Spring Petclinic Microservices & 10 & 1.9 & 2 & 12 & 1.9 & 2 \\
Grafana QuickPizza & 10 & 3.0 & 6 & 12 & 3.0 & 10 \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{axis}[
    ...
    ymin=0,
    ylabel={Zero windows},
    symbolic x coords={{Train-Ticket},{Timescale OpenTelemetry Demo},{Spring Petclinic Microservices},{Grafana QuickPizza}},
    xtick=data,
    xticklabel style={rotate=24,anchor=east,font=\scriptsize,align=right,text width=1.45cm},
    nodes near coords,
    nodes near coords style={font=\scriptsize},
...
\addplot coordinates {({Train-Ticket},0) ({Timescale OpenTelemetry Demo},0) ({Spring Petclinic Microservices},2) ({Grafana QuickPizza},10)};
\end{axis}
\end{tikzpicture}
\caption{Runtime-change zero-window count by system}
\end{figure}
