...
REPORT_PATH = REPORTS_DIR / "rq2_timescale_otel_demo_report.html"
SYSTEM_NAME = "Timescale OpenTelemetry Demo"
DESCRIPTION = "The Timescale OpenTelemetry Demo is a smaller password-generation microservice application with a strong observability pipeline. For RQ2 it provides a lighter-weight contrast to Train-Ticket."
CAVEAT = "Reward should be interpreted carefully here because the Timescale reward function is not a pure runtime-performance score."
...
SCENARIO_TEXT = {"healthy": "Baseline application behavior with no added delay and no injected application error rate.", "latency_spike": "Application delay is increased substantially while keeping the injected error rate at zero.", "error_burst": "The injected application error rate is increased while delay is kept at the baseline.", "throughput_drop": "Moderate added delay plus a mild error rate increase, intended to reduce achieved throughput."}
